...
- Remove implementation of three-step method by Constantin et al. (2024) from
  the package. The method will be available as a separate that will work in
  conjunction with the `powerly` package.
...
## Changed
- Add reference to online documentation in `README.md` file.
- Moved image assets from `inst/` under `docs/`.
- Simplify `ASCII` console logo to include domain name for the online
  documentation.
